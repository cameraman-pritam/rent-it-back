...
const InputTextarea = lazy(() =>
  import("primereact/inputtextarea").then((module) => ({
    default: module.InputTextarea,
  }))
);
const Dropdown = lazy(() =>
  import("primereact/dropdown").then((module) => ({
    default: module.Dropdown,
  }))
);
const InputNumber = lazy(() =>
  import("primereact/inputnumber").then((module) => ({
    default: module.InputNumber,
  }))
);
const Button = lazy(() =>
  ...
  return (
    <Suspense fallback={<Skeleton />}>
      <div onKeyDown={handleKeyDown}>
        <Root />
        <Toast ref={toast} />
        <main className="pt-32 pb-24 max-w-full mx-auto px-6">
          ...
          {/* 10-column grid for the 70/30 split. Flex column on mobile. */}
          <div className="flex flex-col lg:grid lg:grid-cols-10 gap-12">
            {/* Left Column: Form Content (70% on desktop, Order 2 on mobile) */}
            ...
            {/* Right Column: Sidebar Guidance (30% on desktop, Order 1 on mobile) */}
            <aside className="order-1 lg:order-2 lg:col-span-2 space-y-6">
              <div className="bg-surface-container-high rounded-xl p-6 sticky top-32">
                ...
                <div className="space-y-4">
                  <div className="flex items-start gap-3">
                    ...
                    <span className="text-sm font-medium">
                      Use descriptive titles like "Heavy Duty Bosch Hammer
                      Drill"
                    </span>
                  </div>
                  <div className="flex items-start gap-3">
                ...
                <div className="mt-8 pt-6 border-t border-outline-variant/30">
                  <img
                    ...
                    className="w-full sm:w-auto h-40 object-cover rounded-lg mb-4"
                    src={sustain}
                  />
